...
type ResponseAPI interface {
	ResponseAPIBase | ResponseAPIGetPlaylists | ResponseAPIAddPlaylist |
		ResponseAPIGetPlaylist | ResposeUpdatePlaylist | ResponseAPIGetRecentPlaylists |
		ResponseAPIGetPopularPlaylists |
		ResponseAdminBan
	IsSuccess() bool
	ErrorMessage() string
}
